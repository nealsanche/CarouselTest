...
/*
        ...
        carousel.setTiltAngleZ(90);
        carousel.setTiltAngleY(30);
*/
        ...
        for (int i = 0; i < 10; i++) {
            ...
            child.setImageRotation(0);
            child.setBlurMode(BlurMode.FLAT);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            for (int i = 0; i < 5; i++) {
                final CarouselItem child = new CarouselItem(getActivity());
